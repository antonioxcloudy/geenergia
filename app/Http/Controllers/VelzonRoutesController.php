...
class VelzonRoutesController extends Controller
{
    ...
    {
        return Inertia::render('genergia/index');
    }

    public function pvsystem()
    {
        return Inertia::render('genergia/pvsystem');
    }
    public function bess()
    {
        return Inertia::render('genergia/bess');
    }
    public function output()
    {
        return Inertia::render('genergia/output');
    }
