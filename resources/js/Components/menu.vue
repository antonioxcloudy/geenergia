  ...
  <BContainer fluid>
    ...
    <template v-if="layoutType === 'vertical' || layoutType === 'semibox'">
      <ul class="navbar-nav h-100" id="navbar-nav">
        <li class="menu-title">
          <span data-key="t-menu"> GENERGIA </span>
        </li>
           <li class="nav-item">
          <Link class="nav-link menu-link" href="/">
          <i class=" ri-sun-cloudy-line"></i>
          <span data-key="t-meteo">Meteo</span>
          </Link>
        </li>
          <li class="nav-item">
          <Link class="nav-link menu-link" href="/pvsystem">
          <i class=" ri-voice-recognition-line"></i>
          <span data-key="t-pvsystem">PV System</span>
          </Link>
        </li>
          <li class="nav-item">
          <Link class="nav-link menu-link" href="/bess">
          <i class="  ri-battery-2-charge-line"></i>
          <span data-key="t-bess">BESS</span>
          </Link>
        </li>
           <li class="nav-item">
          <Link class="nav-link menu-link" href="/output">
          <i class="ri-guide-line"></i>
          <span data-key="t-bess">Output</span>
          </Link>
        </li>
        <!-- <li class="nav-item">
